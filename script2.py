    ...
    if request.method == 'POST':
        ...
        try:
            ...
            try:
                ...
                writer = pandas.ExcelWriter(file_name1, engine='xlsxwriter')
                df.to_excel("uploads/"+file_name1,sheet_name='Sheet1',header= heads,index=False)
                final_result = "result_"+file_name1
                workbook = xlsxwriter.Workbook("uploads/"+file_name1)
                worksheet = workbook.add_worksheet()
                df1=pandas.read_excel("uploads/"+file_name,sheetname="Sheet1")
                df2=df1.iloc[:,2:-2]
                ...
                #chart.add_series({'values': '=Sheet1!$A$1:$A$5'})
                    chart.add_series({'name':x[t],'categories': '=Sheet2!$'+gt[t]+'$2:$'+gt[t]+'$8','values': '=Sheet2!$'+o[t]+'$2:$'+o[t]+'$8'})
